...
#region Иконки
		...
		private string LOGO_RuTr = "https://rutrk.org/logo/logo.png";
		private string LOGO_TrackerRutor = "http://mega-tor.org/s/logo.jpg";
		private string LOGO_NoNaMeClub = "http://assets.nnm-club.ws/forum/images/logos/10let8.png";
#endregion
...
//ORIGINAL LINE: Function GetListSettings(context As IPluginContext, Optional ByVal ParametrSettings As String = "") As PluginApi.Plugins.Playlist
		...
		public PluginApi.Plugins.Playlist GetList(IPluginContext context)
		{
			...
			//тв
			switch (((string)(PathSpliter[PathSpliter.Length - 1])).Substring(((string)(PathSpliter[PathSpliter.Length - 1])).Length - 7))
			{
				case ".iproxy":
...
//ORIGINAL LINE: Function PlayListPlugPar(ByVal items As System.Collections.Generic.List(Of Item), ByVal context As IPluginContext, Optional ByVal next_page_url As String = "") As PluginApi.Plugins.Playlist
		...
		public PluginApi.Plugins.Playlist GetTopList(IPluginContext context)
		{
			...
			try
			{
				...
				ItemNNMClub.Description = "<html><font face=\" Arial\" size=\" 5\"><b>Трекер " + ItemNNMClub.Name + "</font></b><p><img src=\"" + LOGO_NoNaMeClub + "\" /> <p>" + Description_NNMC + "</html>";
