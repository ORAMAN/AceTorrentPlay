...
{    [PluginAttribute(Id = "acetorrentplay", Version = "0.2.b", Author = "ORAMAN", Name = "AceTorrentPlay", Description = "Воспроизведение файлов TORRENT через меда-сервер Ace Stream", ImageLink = "http://s1.iconbird.com/ico/1012/AmpolaIcons/w256h2561350597291utorrent2.png")]
    public class AceTorrentPlay : IPlugin
    {
        ...
        public string FormatDescriptionFile(string HTML)
        {
            ...
            return "<html><captionn align=\"left\" valign=\"top\"><strong>" + Title + "</strong></caption>" + SidsPirs + "<table><tbody><tr><th align=\"left\" width=\"220\" valign=\"top\"><img src=\"" + ImagePath + "\"width=\"220\" height=\"290\"/></th><th valign=\"top\" width=\"660\"  align=\"left\">" + InfoFile + " </th></tr></tbody></table><div> <font face=\"Arial Narrow\" size=\"3\">" + Opisanie + "</font></div></html>";
        ...
        public string FormatDescription(string HTML, string ImagePath)
        {
            ...
            return "<html><table width=\"100%\" border=\"0\" ><captionn align=\"left\"  valign=\"top\"><strong>" + Title + "</strong></caption><tbody><tr><th width=\"225\" align=\"left\" valign=\"top\"><img src=\"" + ImagePath + "\" width=\"220\" height=\"290\"/></th><th width=\"660\" align=\"left\" valign=\"top\">" + "<font face=\"Arial Narrow\" size=\"3\">" + InfoFile + InfoPro + "</th></tr></tbody></table>" + InfoFilms + "</html>";
