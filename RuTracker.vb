...
Namespace RemoteFork.Plugins
    ...
    <PluginAttribute(Id:="rutracker", Version:="0.15b", Author:="ORAMAN", Name:="RuTracker", Description:="", ImageLink:="http://s1.iconbird.com/ico/1012/AmpolaIcons/w256h2561350597291videofile.png")>
