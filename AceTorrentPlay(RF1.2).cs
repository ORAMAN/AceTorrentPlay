...
namespace RemoteFork.Plugins
{
    ...
    public class AceTorrentPlayPlugin : BasePlugin
    {
        ...
        public PlayList[] GetFileListJSON(string PathTorrent, string ServerAdress)
        {
            System.Net.WebClient WC = new System.Net.WebClient();
            WC.Headers.Add("user-agent", "Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:47.0) Gecko/20100101 Firefox/47.0");
            WC.Encoding = System.Text.Encoding.UTF8;
            ...
            PlayList[] PlayListTorrent = new PlayList[(ListSplit.Length / 2) - 2 + 1];
            int N = 0;
